...
%JAVA% -jar %GF_CLI% --user admin --passwordfile password.txt --host vdataportal0%NUMBER% redeploy --force --keepstate=true --name=DataPortalCare DataPortalCare\target\DataPortalCare.war
