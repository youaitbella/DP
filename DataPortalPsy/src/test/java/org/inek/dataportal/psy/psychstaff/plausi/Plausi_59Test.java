...
class Plausi_59Test {
    ...
    void isPlausiCheckOkWithWrongExceptionFactTest(int wrongId) {
        Plausi_59 plausi = new Plausi_59();
    ...
    void isPlausiCheckOkWithCorrectExceptionFactTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 1, 0, 0, 650000,"Gruppe 1"));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 2, 0, 0, 150001,"Gruppe 2"));
    ...
    void isPlausiCheckOkWithCompleteTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 1, 0, 0, 150000,"Gruppe 1"));
    ...
    void isPlausiCheckOkWithComplete2Test(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 1, 0, 0, 600000,"Gruppe 1"));
    ...
    void isPlausiCheckOkWithBudgetNoCostTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 3, 0, 0,10000000,"Gruppe 3"));
