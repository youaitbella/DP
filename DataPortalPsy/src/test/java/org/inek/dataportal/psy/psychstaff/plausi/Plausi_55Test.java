...
class Plausi_55Test {
    ...
    void isPlausiCheckOkWithWrongExceptionFactTest(int wrongId) {
        Plausi_55 plausi = new Plausi_55();
    ...
    void isPlausiCheckOkWithCorrectExceptionFactTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 1, 0, 0, 0,"Gruppe 1"));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 2, 0, 0, 0,"Gruppe 2"));
    ...
    void isPlausiCheckOkWithCorrectExceptionFactAndIsForKidsTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 3, 0, 0,0));
    ...
    void isPlausiCheckOkWithBudgetNoCostTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 3, 0, 0,0,"Gruppe 3"));
