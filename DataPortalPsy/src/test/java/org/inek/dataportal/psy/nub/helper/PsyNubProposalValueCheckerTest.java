...
class PsyNubProposalValueCheckerTest {

    @ParameterizedTest
    @ValueSource(strings = {"01/02", "12/12", "05/68", "01/99", "01/00", ""})
    void isValidStringForDateValueWithValidValues(String value) {
        Assertions.assertThat(PsyNubProposalValueChecker.isValidStringForDateValue(value)).isTrue();
    }
    ...
    void isValidStringForDateValueWithNotValidValues(String value) {
        Assertions.assertThat(PsyNubProposalValueChecker.isValidStringForDateValue(value)).isFalse();
    }
}