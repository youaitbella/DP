...
class Plausi_56Test {
    ...
    void isPlausiCheckOkWithWrongExceptionFactTest(int wrongId) {
        Plausi_56 plausi = new Plausi_56();
    ...
    void isPlausiCheckOkWithCorrectExceptionFactTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 1, 0, 0, 77,"Gruppe 1"));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 2, 0, 0, 0.1,"Gruppe 2"));
    ...
    void isPlausiCheckOkWithCompleteTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 1, 0, 0, 35000,"Gruppe 1"));
    ...
    void isPlausiCheckOkWithComplete2Test(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 1, 0, 0, 55,"Gruppe 1"));
    ...
    void isPlausiCheckOkWithBudgetNoCostTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 3, 0, 0,50,"Gruppe 3"));
