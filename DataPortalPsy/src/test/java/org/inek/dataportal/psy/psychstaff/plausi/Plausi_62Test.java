...
class Plausi_62Test {
    ...
    void isPlausiCheckOkWithWrongExceptionFactTest(int wrongId) {
        Plausi_62 plausi = new Plausi_62();
    ...
    void isPlausiCheckOkWithNoSumAgreedCompleteOrBudgetTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 1, 0, 50, 0));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 2, 0, 0, 0));
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Adults, 1, 50, 0, 0, 0));
    ...
    void isPlausiCheckOkWithNoSumCompleteAgreedNoAvgTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 1, 0, 50, 0, "Gruppe 1"));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Adults, 2, 0, 1, 0, "Gruppe 2"));
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Adults, 1, 60000, 2, 2, 2));
