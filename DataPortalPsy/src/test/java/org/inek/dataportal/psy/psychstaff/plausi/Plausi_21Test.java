...
class Plausi_21Test {
    ...
    void isPlausiCheckOkWithWrongExceptionFactTest(int wrongId) {
        Plausi_21 plausi = new Plausi_21();
    ...
    void isPlausiCheckOkWithCorrectExceptionFactTest(int correctId) {
        ...
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Adults, 1, 1, 0, 0,0));
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Adults, 2, 1, 0, 0,0));
