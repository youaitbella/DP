...
class Plausi_28Test {
    ...
    void isPlausiCheckOkWithWrongExceptionFactTest(int wrongId) {
        Plausi_28 plausi = new Plausi_28();
        ...
        staffProof.setKidsEffectiveCosts(500);
    ...
    void isPlausiCheckOkWithNoSumBudgetAgreedAndAvgOkTest(int correctId) {
        ...
        staffProof.setExclusionFact1(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setExclusionFact2(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setKidsEffectiveCosts(11955623);
        staffProof.setStatusApx1(0);
        staffProof.setStatusApx2(10);

        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 1, 0, 29.50, 90366));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 2, 0, 135.03, 60707));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 3, 0, 3.31, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 4, 0, 7.35, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 5, 0, 2.70, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 7, 0, 12.25, 55.937));
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Kids, 1, 2, 2, 2, 2));
    ...
    void isPlausiCheckOkWithNoSumBudgetAgreedAndAvgNotOkTest(int correctId) {
        ...
        staffProof.setExclusionFact1(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setExclusionFact2(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setKidsEffectiveCosts(119325562);
        staffProof.setStatusApx1(0);
        staffProof.setStatusApx2(10);
    ...
    void isPlausiCheckOkWithSumCompleteAgreedAndAvgOkTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 3,  3.31,0, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 4,  7.35, 0,65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 5,  2.70, 0,65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 7,  12.25, 0,55.937));
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Kids, 1, 2, 2, 2, 2));
    ...
    void isPlausiCheckOkWithSumCompleteAgreedAndAvgNotOkTest(int correctId) {
        ...
        staffProof.setExclusionFact1(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setExclusionFact2(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setKidsEffectiveCosts(119552622);
        staffProof.setStatusApx1(0);
        staffProof.setStatusApx2(10);
    ...
    void isPlausiCheckOkWithSumCompleteAndBudgetOkTest(int correctId) {
        ...
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 1, 529.50,29.50, 90366));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 2, 135.03,135.03, 60707));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 3, 3.31,3.31, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 4, 7.35,7.35, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 5, 2.70,2.70, 65675));
        staffProof.addStaffProofAgreed(PlausiTestHelper.createStaffProofAgreed(PsychType.Kids, 7, 12.25,12.25, 55.937));
        staffProof.addStaffProofEffective(PlausiTestHelper.createStaffProofEffective(PsychType.Kids, 1, 2, 2, 2, 2));
    ...
    void isPlausiCheckOkWithWrongStateTest(int correctId) {
        ...
        staffProof.setExclusionFact1(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setExclusionFact2(PlausiTestHelper.getExclusionFact(correctId));
        staffProof.setKidsEffectiveCosts(1195562);
        staffProof.setStatusApx1(0);
