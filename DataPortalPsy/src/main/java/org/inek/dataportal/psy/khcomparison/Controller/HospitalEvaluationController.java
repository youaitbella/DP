 ...
 * @author lautenti
 */
public class HospitalEvaluationController extends AbstractFeatureController {

    public HospitalEvaluationController(SessionController sessionController) {
    ...
    public Feature getFeature() {
        return Feature.HOSPITAL_EVALUATION;
    }
