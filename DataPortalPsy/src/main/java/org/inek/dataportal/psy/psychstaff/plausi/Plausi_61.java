...
public class Plausi_61 implements PsyStaffPlausi {

    private String _errorMessageTemplate = "In Anlage 1 (KJP) erscheint das Verhältnis der Angaben zwischen den Spalten " +
