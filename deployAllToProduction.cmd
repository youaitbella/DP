...
%JAVA% -jar %GF_CLI% --user admin --passwordfile password.txt --host vdataportal01 redeploy --force --keepstate=true --name=DataPortalCare DataPortalCare\target\DataPortalCare.war
...
%JAVA% -jar %GF_CLI% --user admin --passwordfile password.txt --host vdataportal02 redeploy --force --keepstate=true --name=DataPortalCare DataPortalCare\target\DataPortalCare.war
